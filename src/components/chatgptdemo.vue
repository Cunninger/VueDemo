<template>
    ...
    <div class="background">
        ...
        <div>
            ...
            <select style="width: 100px; height: 50px;bottom: 0;left: 75%; position:fixed; bottom: 0; left: 65%; transform: translateX(-50%);" v-model="model">
            ...
            try {
                const response = await axios.post('https://proxy.cocopilot.org/v1/chat/completions', {
                    ...
                    headers: {
                        ...
                        'Authorization': 'Bearer ghu_CfazhnHu9FpSrbaQxiIynCifVdw6pM0QysaJ'
                    }
                });
